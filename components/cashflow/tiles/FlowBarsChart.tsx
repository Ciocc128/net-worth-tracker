          ...
          {flows.map((flow, i) => {
            ...
            return (
              <g key={flow.key}>
                ...
                <rect x={x} y={VIEW_H - incomeHeight} width={barWidth} height={incomeHeight} fill="var(--flow-in)" fillOpacity={opacity} stroke={stroke} vectorEffect="non-scaling-stroke" />
                <rect x={x + barWidth + gap} y={VIEW_H - expensesHeight} width={barWidth} height={expensesHeight} fill="var(--flow-out)" fillOpacity={opacity} stroke={stroke} vectorEffect="non-scaling-stroke" />
              </g>
            );
          })}
        </svg>
