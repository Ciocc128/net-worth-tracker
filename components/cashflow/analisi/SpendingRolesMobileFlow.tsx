 ...
 * covered, i.e. what left — so the bar and the sentence print the same figures. A deficit is the
 * red «entrate» line inside the bar. The role headers print amounts only.
 *
