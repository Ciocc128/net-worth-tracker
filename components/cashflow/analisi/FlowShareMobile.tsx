...
/**
 * Flusso on a phone, in either view: one share bar, then each group's categories as ranked rows.
 * A Sankey gets ~80 px a column at 390 and stops saying anything (owner, 2026-09-15 for the roles
 * view, 2026-09-25 for the type view), so both views draw this instead, fed by their own mapping
 * (SpendingRolesMobileFlow, SpendingTypesMobileFlow).
 *
 * The bar is proportion only; the shares are printed in the legend under it, in the foreground
 * ink. They used to sit inside the segments in white, which measured 1,30–7,30:1 across the theme
 * blocks' chart slots (2026-09-25) — and a thin segment clipped its figure away entirely.
 */
