 ...
 * (`YearBars`). The callers name the bins; this knows only bars. Colour is `--scenario-base`, the
 * token every base scenario on the page already wears (`--chart-1` unless a theme names it,
 * `SCENARIO_COLOR`); a `neutral` bar (a bin that is not a value of the
            ...
            return (
              <g key={bar.key}>
                ...
                <rect
                  ...
                  width={barWidth}
                  height={height}
                  fill={bar.neutral ? 'var(--muted-foreground)' : 'var(--scenario-base)'}
