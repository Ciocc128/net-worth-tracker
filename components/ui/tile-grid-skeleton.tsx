...
function SkeletonTile({ lines }: { lines: number }) {
  return (
    <div className="flex-1 rounded-2xl border border-border bg-card p-5">
      <div className="mb-3 h-2.5 w-24 animate-pulse rounded bg-muted" />
      <div className="mb-4 h-[13px] w-4/5 animate-pulse rounded bg-muted" />
 ...
 */
export function TileGridSkeleton({ verdict = true, cells = DEFAULT_SKELETON_CELLS, className }: TileGridSkeletonProps) {
  return (
