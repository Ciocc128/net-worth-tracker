...
export const HEATMAP_STEPS = [
  { below: 1, intensity: 30, positiveClass: 'bg-(--sign-chart-gain)/30', negativeClass: 'bg-(--sign-chart-loss)/30' },
  { below: 2.5, intensity: 55, positiveClass: 'bg-(--sign-chart-gain)/55', negativeClass: 'bg-(--sign-chart-loss)/55' },
  { below: Number.POSITIVE_INFINITY, intensity: 85, positiveClass: 'bg-(--sign-chart-gain)/85', negativeClass: 'bg-(--sign-chart-loss)/85' },
] as const;
