...
- **Centri di Costo** — opening a center as a navigation (URL, reload, the browser's Back, the
  ...
  reading line with nothing written, the armed delete that moves nothing, and on a phone the
  detail landing at the top with every target at 44px.
