...
export interface AssetAllocationSettings {
  ...
  // RITA rule inputs (Spec 3) — resolve when a pension fund unlocks in the FIRE bridge model,
...
export interface MonteCarloParams {
  ...
  // One-off capital arrivals during the simulated horizon (Spec 3: a pension fund unlocking).
