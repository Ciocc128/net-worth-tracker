...
/**
 * The Flusso «Per tipo» on a phone, in numbers (owner's call, 2026-09-25): the reading's type
 ...
 * spending and the savings over the income, and the owner's rule of 2026-09-15 is one base per
 * screen. Savings therefore sit outside the bar, as `surplus`.
 *
